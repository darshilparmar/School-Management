...
<div id="nav">
<font color="white"><a href="#students">Students</a></font><br>
...
<ul id="dropdown1" class="dropdown-content">
  ...
  <li><a href="suddetails.html">Student Details</a></li>
   <li><a href="newadd.asp">New Admissions Details</a></li>
...
<ul id="dropdown3" class="dropdown-content">
  <li><a href="Examschedule.asp">Exam Schedule</a></li>
  <li><a href="timetable.asp">School time-table</a></li>
  <li><a href="holidays.asp">Holidays List </a></li>
 <li><a href="noticebd.asp"> Notice  Board</a></li>
 
</ul>
<nav>
  <div class="nav-wrapper">
    <a href="#!" class="brand-logo">Student Zone</a>
    ...
    <ul class="right hide-on-med-and-down">
      ...
      <li><a class="dropdown-button" href="#!" data-activates="dropdown1">Student info<i class="material-icons right">arrow_drop_down</i></a></li>
	   <li><a class="dropdown-button" href="#!" data-activates="dropdown3">Notices<i class="material-icons right">arrow_drop_down</i></a></li>
	  <li><a  href="showfeed.asp">Feedbacks</a></i>
    </ul>
  </div>
</nav>
